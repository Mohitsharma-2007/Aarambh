...
class AdvancedChartsManager:
    ...
    def __init__(self):
        ...
        self.groww_config = {
            "api_key": "eyJraWQiOiJaTUtjVXciLCJhbGciOiJFUzI1NiJ9..R0SoRTG52YyMPaDmbvxzuFw5RskIGsHSPP1KUyqgHDB_flcbzaXDATqw7EZGQTYRotxbI0sXRBy7kJZTUpWgg",
            ...
            async with aiohttp.ClientSession(
                ...
                async with session.get(income_url, params=params) as response:
                    if response.status == 200:
                        ...
                        async with session.get(balance_url, params=params) as balance_response:
                            if balance_response.status == 200:
                                balance_data = await balance_response.json()
                                
                                # Get cash flow
                                cashflow_url = f"{self.base_urls['financial_modeling_prep']}/cash-flow-statement/{symbol}"
                                async with session.get(cashflow_url, params=params) as cashflow_response:
