...
from ..models.ontology_project import OntologyProjectManager
...
def get_entity_detail(graph_id: str, entity_uuid: str):
    ...
    try:
        ...
        if not entity:
            return jsonify({
                "success": False,
                "error": f"å®žä½“ä¸å­˜åœ¨: {entity_uuid}"
            }), 404
...
def prepare_simulation():
    ...
    try:
        ...
        # ä»Žé¡¹ç›®èŽ·å–å¿…è¦ä¿¡æ¯
        project = OntologyProjectManager.get_project(state.project_id)
        if not project:
            return jsonify({
                "success": False,
        ...
        # èŽ·å–æ–‡æ¡£æ–‡æœ¬
        document_text = OntologyProjectManager.get_project_text(state.project_id) or ""
...
def get_simulation_history():
    ...
    try:
        ...
        for sim in simulations:
            ...
            project = OntologyProjectManager.get_project(sim.project_id)
