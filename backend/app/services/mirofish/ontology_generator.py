...
**CANNOT BE**:
- Abstract concepts (such as "public opinion", "emotions", "trends")
...
**Hierarchy requirements (must include both specific types and catch-all types)**:

Your 10 entity types must include the following hierarchy:

A. **Catch-all types (must be included, place at the end of the list)**:
   - `Person`: The catch-all type for any natural person. When a person does not belong to other more specific person types, they fall into this category.
   - `Organization`: The catch-all type for any organization. When an organization does not belong to other more specific organization types, it falls into this category.
...
- Various people will appear in the text, such as "primary and secondary school teachers", "passerby A", "some netizen"
...
2. Last 2 must be catch-all types: Person (for individuals) and Organization (for organizations)
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Finally ensure does not exceed limit (defensive programming)
