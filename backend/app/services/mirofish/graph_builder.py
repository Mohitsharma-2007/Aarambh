...
Interface 2: Use Zep API to build Standalone Graph
"""
...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by Zep SDK, warning comes from dynamic class creation, safe to ignore
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # Zep API requires Field's description, this is required
