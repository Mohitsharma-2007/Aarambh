...
Simulation Report Generation using LangChain + Zep in ReACT Pattern

Features:
1. Generate reports based on simulation requirements and Zep graph information
2. Plan directory structure first, then generate in segments
...
class ReportLogger:
    ...
    Generates agent_log.jsonl file in the report folder, recording every step in detail.
    ...
    def log_planning_context(self, context: Dict[str, Any]):
        """Record planning context information"""
        self.log(
