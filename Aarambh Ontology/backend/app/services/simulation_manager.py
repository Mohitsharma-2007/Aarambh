...
logger = get_logger('aarambh.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if progress_callback:
                progress_callback("reading", 0, "æ­£åœ¨è¿žæŽ¥Zepå›¾è°±...")
            
            reader = ZepEntityReader()
            
            if progress_callback:
                progress_callback("reading", 30, "æ­£åœ¨è¯»å–èŠ‚ç‚¹æ•°æ®...")
            ...
            if progress_callback:
                progress_callback(
                    "reading", 100, 
                    f"å®Œæˆï¼Œå…± {filtered.filtered_count} ä¸ªå®žä½“",
            ...
            if progress_callback:
                progress_callback(
                    ...
                    f"å®Œæˆï¼Œå…± {len(profiles)} ä¸ªProfile",
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. æ¿€æ´»condaçŽ¯å¢ƒ: conda activate aarambh\n"
