...
logger = get_logger('aarambh.zep_tools')
...
class ZepToolsService:
    ...
    def __init__(self, api_key: Optional[str] = None, llm_client: Optional[LLMClient] = None):
        ...
        logger.info("ZepToolsService åˆå§‹åŒ–å®Œæˆ")
    ...
    def search_graph(
        ...
        """
        logger.info(f"å›¾è°±æœç´¢: graph_id={graph_id}, query={query[:50]}...")
        ...
        try:
            search_results = self._call_with_retry(
                ...
                operation_name=f"å›¾è°±æœç´¢(graph={graph_id})"
            )
            ...
            logger.info(f"æœç´¢å®Œæˆ: æ‰¾åˆ° {len(facts)} æ¡ç›¸å…³äº‹å®ž")
            ...
            logger.warning(f"Zep Search APIå¤±è´¥ï¼Œé™çº§ä¸ºæœ¬åœ°æœç´¢: {str(e)}")
    ...
    def _local_search(
        ...
        Returns:
            SearchResult: æœç´¢ç»“æžœ
        """
        logger.info(f"ä½¿ç”¨æœ¬åœ°æœç´¢: query={query[:30]}...")
        ...
        try:
            ...
            logger.info(f"æœ¬åœ°æœç´¢å®Œæˆ: æ‰¾åˆ° {len(facts)} æ¡ç›¸å…³äº‹å®ž")
            
        except Exception as e:
            logger.error(f"æœ¬åœ°æœç´¢å¤±è´¥: {str(e)}")
    ...
    def get_all_nodes(self, graph_id: str) -> List[NodeInfo]:
        ...
        logger.info(f"èŽ·å–åˆ° {len(result)} ä¸ªèŠ‚ç‚¹")
        return result
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        ...
        logger.info(f"èŽ·å–åˆ° {len(result)} æ¡è¾¹")
        return result
    ...
    def get_node_detail(self, node_uuid: str) -> Optional[NodeInfo]:
        ...
        Returns:
            èŠ‚ç‚¹ä¿¡æ¯æˆ–None
        """
        logger.info(f"èŽ·å–èŠ‚ç‚¹è¯¦æƒ…: {node_uuid[:8]}...")
        
        try:
            node = self._call_with_retry(
                func=lambda: self.client.graph.node.get(uuid_=node_uuid),
                operation_name=f"èŽ·å–èŠ‚ç‚¹è¯¦æƒ…(uuid={node_uuid[:8]}...)"
            )
            ...
            logger.error(f"èŽ·å–èŠ‚ç‚¹è¯¦æƒ…å¤±è´¥: {str(e)}")
            return None
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Returns:
            è¾¹åˆ—è¡¨
        """
        logger.info(f"èŽ·å–èŠ‚ç‚¹ {node_uuid[:8]}... çš„ç›¸å…³è¾¹")
        ...
        try:
            ...
            logger.info(f"æ‰¾åˆ° {len(result)} æ¡ä¸ŽèŠ‚ç‚¹ç›¸å…³çš„è¾¹")
            return result
            
        except Exception as e:
            logger.warning(f"èŽ·å–èŠ‚ç‚¹è¾¹å¤±è´¥: {str(e)}")
            return []
    ...
    def get_entities_by_type(
        ...
        """
        logger.info(f"èŽ·å–ç±»åž‹ä¸º {entity_type} çš„å®žä½“...")
        ...
        logger.info(f"æ‰¾åˆ° {len(filtered)} ä¸ª {entity_type} ç±»åž‹çš„å®žä½“")
        return filtered
    ...
    def get_entity_summary(
        ...
        Returns:
            å®žä½“æ‘˜è¦ä¿¡æ¯
        """
        logger.info(f"èŽ·å–å®žä½“ {entity_name} çš„å…³ç³»æ‘˜è¦...")
    ...
    def get_graph_statistics(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            ç»Ÿè®¡ä¿¡æ¯
        """
        logger.info(f"èŽ·å–å›¾è°± {graph_id} çš„ç»Ÿè®¡ä¿¡æ¯...")
    ...
    def get_simulation_context(
        ...
        Returns:
            æ¨¡æ‹Ÿä¸Šä¸‹æ–‡ä¿¡æ¯
        """
        logger.info(f"èŽ·å–æ¨¡æ‹Ÿä¸Šä¸‹æ–‡: {simulation_requirement[:50]}...")
    ...
    def insight_forge(
        ...
        """
        logger.info(f"InsightForge æ·±åº¦æ´žå¯Ÿæ£€ç´¢: {query[:50]}...")
        ...
        logger.info(f"InsightForgeå®Œæˆ: {result.total_facts}æ¡äº‹å®ž, {result.total_entities}ä¸ªå®žä½“, {result.total_relationships}æ¡å…³ç³»")
        return result
...
è¿”å›žJSONæ ¼å¼çš„å­é—®é¢˜åˆ—è¡¨ã€‚"""
        ...
        try:
            ...
            logger.warning(f"ç”Ÿæˆå­é—®é¢˜å¤±è´¥: {str(e)}ï¼Œä½¿ç”¨é»˜è®¤å­é—®é¢˜")
    ...
    def panorama_search(
        ...
        """
        logger.info(f"PanoramaSearch å¹¿åº¦æœç´¢: {query[:50]}...")
        ...
        logger.info(f"PanoramaSearchå®Œæˆ: {result.active_count}æ¡æœ‰æ•ˆ, {result.historical_count}æ¡åŽ†å²")
        return result
    ...
    def quick_search(
        ...
        Returns:
            SearchResult: æœç´¢ç»“æžœ
        """
        logger.info(f"QuickSearch ç®€å•æœç´¢: {query[:50]}...")
        ...
        logger.info(f"QuickSearchå®Œæˆ: {result.total_count}æ¡ç»“æžœ")
        return result
    ...
    def interview_agents(
        ...
        logger.info(f"InterviewAgents æ·±åº¦é‡‡è®¿ï¼ˆçœŸå®žAPIï¼‰: {interview_requirement[:50]}...")
        ...
        if not result.interview_questions:
            ...
            logger.info(f"ç”Ÿæˆäº† {len(result.interview_questions)} ä¸ªé‡‡è®¿é—®é¢˜")
        ...
        try:
            ...
            logger.info(f"è°ƒç”¨æ‰¹é‡é‡‡è®¿APIï¼ˆåŒå¹³å°ï¼‰: {len(interviews_request)} ä¸ªAgent")
            ...
            logger.info(f"é‡‡è®¿APIè¿”å›ž: {api_result.get('interviews_count', 0)} ä¸ªç»“æžœ, success={api_result.get('success')}")
            
            # æ£€æŸ¥APIè°ƒç”¨æ˜¯å¦æˆåŠŸ
            if not api_result.get("success", False):
                error_msg = api_result.get("error", "æœªçŸ¥é”™è¯¯")
                logger.warning(f"é‡‡è®¿APIè¿”å›žå¤±è´¥: {error_msg}")
            ...
            # æ¨¡æ‹ŸçŽ¯å¢ƒæœªè¿è¡Œ
            logger.warning(f"é‡‡è®¿APIè°ƒç”¨å¤±è´¥ï¼ˆçŽ¯å¢ƒæœªè¿è¡Œï¼Ÿï¼‰: {e}")
        ...
        logger.info(f"InterviewAgentså®Œæˆ: é‡‡è®¿äº† {result.interviewed_count} ä¸ªAgentï¼ˆåŒå¹³å°ï¼‰")
        return result
    ...
    def _load_agent_profiles(self, simulation_id: str) -> List[Dict[str, Any]]:
        ...
        if os.path.exists(reddit_profile_path):
            try:
                ...
                logger.info(f"ä»Ž reddit_profiles.json åŠ è½½äº† {len(profiles)} ä¸ªäººè®¾")
                return profiles
            except Exception as e:
        ...
        if os.path.exists(twitter_profile_path):
            try:
                ...
                logger.info(f"ä»Ž twitter_profiles.csv åŠ è½½äº† {len(profiles)} ä¸ªäººè®¾")
                return profiles
            except Exception as e:
...
è¯·ç”Ÿæˆ3-5ä¸ªé‡‡è®¿é—®é¢˜ã€‚"""
        ...
        try:
            ...
            logger.warning(f"ç”Ÿæˆé‡‡è®¿é—®é¢˜å¤±è´¥: {e}")
            return [
    ...
    def _generate_interview_summary(
        ...
        system_prompt = """ä½ æ˜¯ä¸€ä¸ªä¸“ä¸šçš„æ–°é—»ç¼–è¾‘ã€‚è¯·æ ¹æ®å¤šä½å—è®¿è€…çš„å›žç­”ï¼Œç”Ÿæˆä¸€ä»½é‡‡è®¿æ‘˜è¦ã€‚
...
- å¼•ç”¨å—è®¿è€…åŽŸè¯æ—¶ä½¿ç”¨ä¸­æ–‡å¼•å·ã€Œã€
...
è¯·ç”Ÿæˆé‡‡è®¿æ‘˜è¦ã€‚"""
        ...
        try:
            ...
            logger.warning(f"ç”Ÿæˆé‡‡è®¿æ‘˜è¦å¤±è´¥: {e}")
            # é™çº§ï¼šç®€å•æ‹¼æŽ¥
