...
logger = get_logger('aarambh.oasis_profile')
...
class OasisProfileGenerator:
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        comprehensive_query = f"å…³äºŽ{entity_name}çš„æ‰€æœ‰ä¿¡æ¯ã€æ´»åŠ¨ã€äº‹ä»¶ã€å…³ç³»å’ŒèƒŒæ™¯"
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """èŽ·å–ç³»ç»Ÿæç¤ºè¯"""
        base_prompt = "ä½ æ˜¯ç¤¾äº¤åª’ä½“ç”¨æˆ·ç”»åƒç”Ÿæˆä¸“å®¶ã€‚ç”Ÿæˆè¯¦ç»†ã€çœŸå®žçš„äººè®¾ç”¨äºŽèˆ†è®ºæ¨¡æ‹Ÿ,æœ€å¤§ç¨‹åº¦è¿˜åŽŸå·²æœ‰çŽ°å®žæƒ…å†µã€‚å¿…é¡»è¿”å›žæœ‰æ•ˆçš„JSONæ ¼å¼ï¼Œæ‰€æœ‰å­—ç¬¦ä¸²å€¼ä¸èƒ½åŒ…å«æœªè½¬ä¹‰çš„æ¢è¡Œç¬¦ã€‚ä½¿ç”¨ä¸­æ–‡ã€‚"
        return base_prompt
...
- ä½¿ç”¨ä¸­æ–‡ï¼ˆé™¤äº†genderå­—æ®µå¿…é¡»ç”¨è‹±æ–‡male/femaleï¼‰
...
- ä½¿ç”¨ä¸­æ–‡ï¼ˆé™¤äº†genderå­—æ®µå¿…é¡»ç”¨è‹±æ–‡"other"ï¼‰
...
- æœºæž„è´¦å·å‘è¨€è¦ç¬¦åˆå…¶èº«ä»½å®šä½"""
    ...
    def _print_generated_profile(self, entity_name: str, entity_type: str, profile: OasisAgentProfile):
        ...
        output_lines = [
            f"\n{separator}",
            f"[å·²ç”Ÿæˆ] {entity_name} ({entity_type})",
            f"{separator}",
