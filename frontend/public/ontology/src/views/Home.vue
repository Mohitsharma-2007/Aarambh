<template>
  <div class="home-container">
    <!-- Top Navigation Bar -->
    <nav class="navbar">
      <div class="nav-brand">aarambh</div>
      <div class="nav-links">
        <a href="https://github.com/666ghj/aarambh" target="_blank" class="github-link">
          Visit our GitHub <span class="arrow">â†—</span>
        </a>
      </div>
    </nav>
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class="highlight-bold">aarambh</span> can automatically generate a parallel world composed of up to <span class="highlight-orange">millions of Agents</span> based on the reality seeds within it. Through a god's-eye view injection of variables, finding <span class="highlight-code">"local optimal solutions"</span> in complex group interactions within dynamic environments
            </p>
            <p class="slogan-text">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="/logo.png" alt="Aarambh Logo" class="hero-logo" />
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          <div class="panel-header">
            <span class="status-dot">â– </span> System Status
          </div>
          
          <h2 class="section-title">Ready to Go</h2>
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Up to Million-Agent Simulation</div>
            </div>
          </div>
          ...
          <div class="steps-container">
            <div class="steps-header">
               <span class="diamond-icon">â—‡</span> Workflow Sequence
            </div>
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity Relationship Extraction & Persona Generation & Environment Config with Realistic Parameters</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-Platform Parallel Simulation & Auto-Analysis of Prediction Needs & Dynamic Timeline Memory Updates</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">Engine: aarambh-V1.0</div>
              </div>
            </div>
...
// Start simulation - jump immediately, API calls handled in Process page
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as main heading font, JetBrains Mono as code/label font
