            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">æ­£åœ¨ç”Ÿæˆ{{ section.title }}...</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'ä¸Žä¸–ç•Œä¸­ä»»æ„ä¸ªä½“å¯¹è¯' }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">é€‰æ‹©å¯¹è¯å¯¹è±¡</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'æœªçŸ¥èŒä¸š' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>å‘é€é—®å·è°ƒæŸ¥åˆ°ä¸–ç•Œä¸­</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">æŠ¥å‘Šç”Ÿæˆæ™ºèƒ½ä½“çš„å¿«é€Ÿå¯¹è¯ç‰ˆæœ¬ï¼Œå¯è°ƒç”¨ 4 ç§ä¸“ä¸šå·¥å…·ï¼Œæ‹¥æœ‰aarambhçš„å®Œæ•´è®°å¿†</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge æ·±åº¦å½’å› </div>
                    <div class="tool-desc">å¯¹é½çŽ°å®žä¸–ç•Œç§å­æ•°æ®ä¸Žæ¨¡æ‹ŸçŽ¯å¢ƒçŠ¶æ€ï¼Œç»“åˆGlobal/Local Memoryæœºåˆ¶ï¼Œæä¾›è·¨æ—¶ç©ºçš„æ·±åº¦å½’å› åˆ†æž</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch å…¨æ™¯è¿½è¸ª</div>
                    <div class="tool-desc">åŸºäºŽå›¾ç»“æž„çš„å¹¿åº¦éåŽ†ç®—æ³•ï¼Œé‡æž„äº‹ä»¶ä¼ æ’­è·¯å¾„ï¼Œæ•èŽ·å…¨é‡ä¿¡æ¯æµåŠ¨çš„æ‹“æ‰‘ç»“æž„</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch å¿«é€Ÿæ£€ç´¢</div>
                    <div class="tool-desc">åŸºäºŽ GraphRAG çš„å³æ—¶æŸ¥è¯¢æŽ¥å£ï¼Œä¼˜åŒ–ç´¢å¼•æ•ˆçŽ‡ï¼Œç”¨äºŽå¿«é€Ÿæå–å…·ä½“çš„èŠ‚ç‚¹å±žæ€§ä¸Žç¦»æ•£äº‹å®ž</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent è™šæ‹Ÿè®¿è°ˆ</div>
                    <div class="tool-desc">è‡ªä¸»å¼è®¿è°ˆï¼Œèƒ½å¤Ÿå¹¶è¡Œä¸Žæ¨¡æ‹Ÿä¸–ç•Œä¸­ä¸ªä½“è¿›è¡Œå¤šè½®å¯¹è¯ï¼Œé‡‡é›†éžç»“æž„åŒ–çš„è§‚ç‚¹æ•°æ®ä¸Žå¿ƒç†çŠ¶æ€</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'æœªçŸ¥èŒä¸š' }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">ç®€ä»‹</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'ä¸Ž Report Agent å¯¹è¯ï¼Œæ·±å…¥äº†è§£æŠ¥å‘Šå†…å®¹' : 'ä¸Žæ¨¡æ‹Ÿä¸ªä½“å¯¹è¯ï¼Œäº†è§£ä»–ä»¬çš„è§‚ç‚¹' }}
              </p>
            </div>
            <div 
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">é€‰æ‹©è°ƒæŸ¥å¯¹è±¡</span>
                <span class="selection-count">å·²é€‰ {{ selectedAgents.size }} / {{ profiles.length }}</span>
              </div>
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'æœªçŸ¥èŒä¸š' }}</span>
                  </div>
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents">å…¨é€‰</button>
                <span class="action-divider">|</span>
                <button class="action-link" @click="clearAgentSelection">æ¸…ç©º</button>
              </div>
            </div>

            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">é—®å·é—®é¢˜</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="è¾“å…¥æ‚¨æƒ³é—®æ‰€æœ‰è¢«é€‰ä¸­å¯¹è±¡çš„é—®é¢˜..."
                rows="3"
              ></textarea>
            </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              <span class="results-title">è°ƒæŸ¥ç»“æžœ</span>
              <span class="results-count">{{ surveyResults.length }} æ¡å›žå¤</span>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'æœªçŸ¥èŒä¸š' }}</span>
                  </div>
                </div>
...
const chatHistoryCache = ref({}) // ç¼“å­˜æ‰€æœ‰å¯¹è¯è®°å½•: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
const selectAgent = (agent, idx) => {
  ...
  // æ¢å¤è¯¥ Agent çš„å¯¹è¯è®°å½•
  chatHistory.value = chatHistoryCache.value[`agent_${idx}`] || []
  addLog(`é€‰æ‹©å¯¹è¯å¯¹è±¡: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // æ¸…ç†åˆ—è¡¨é¡¹ä¹‹é—´çš„æ‰€æœ‰ç©ºç™½
  html = html.replace(/<\/li>\s+<li/g, '</li><li')
  // æ¸…ç†åˆ—è¡¨å¼€å§‹æ ‡ç­¾åŽçš„ç©ºç™½
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // æ¸…ç†åˆ—è¡¨ç»“æŸæ ‡ç­¾å‰çš„ç©ºç™½
  ...
  // æ¸…ç†å—çº§å…ƒç´ å‰åŽçš„ <br> æ ‡ç­¾
  html = html.replace(/<br>\s*(<ul|<ol|<blockquote)/g, '$1')
  html = html.replace(/(<\/ul>|<\/ol>|<\/blockquote>)\s*<br>/g, '$1')
  // æ¸…ç† <p><br> ç´§è·Ÿå—çº§å…ƒç´ çš„æƒ…å†µï¼ˆå¤šä½™ç©ºè¡Œå¯¼è‡´ï¼‰
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // æ¸…ç†è¿žç»­çš„ <br> æ ‡ç­¾
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // æ¸…ç†å—çº§å…ƒç´ åŽç´§è·Ÿçš„æ®µè½å¼€å§‹æ ‡ç­¾å‰çš„ <br>
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // ä¿®å¤éžè¿žç»­æœ‰åºåˆ—è¡¨çš„ç¼–å·ï¼šå½“å•é¡¹ <ol> è¢«æ®µè½å†…å®¹éš”å¼€æ—¶ï¼Œä¿æŒç¼–å·é€’å¢ž
...
const sendMessage = async () => {
  ...
  try {
    ...
    addLog(`å‘é€å¤±è´¥: ${err.message}`)
    chatHistory.value.push({
      role: 'assistant',
      content: `æŠ±æ­‰ï¼Œå‘ç”Ÿäº†é”™è¯¯: ${err.message}`,
      timestamp: new Date().toISOString()
    })
  } finally {
    isSending.value = false
    scrollToBottom()
    // è‡ªåŠ¨ä¿å­˜å¯¹è¯è®°å½•åˆ°ç¼“å­˜
    saveChatHistory()
  }
}

const sendToReportAgent = async (message) => {
  addLog(`å‘ Report Agent å‘é€: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    chatHistory.value.push({
      role: 'assistant',
      content: res.data.response || res.data.answer || 'æ— å“åº”',
      timestamp: new Date().toISOString()
    })
    addLog('Report Agent å·²å›žå¤')
  } else {
    throw new Error(res.error || 'è¯·æ±‚å¤±è´¥')
  }
}

const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('è¯·å…ˆé€‰æ‹©ä¸€ä¸ªæ¨¡æ‹Ÿä¸ªä½“')
  }
  
  addLog(`å‘ ${selectedAgent.value.username} å‘é€: ${message.substring(0, 50)}...`)
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'æé—®è€…' : 'ä½ '}ï¼š${msg.content}`)
      .join('\n')
    prompt = `ä»¥ä¸‹æ˜¯æˆ‘ä»¬ä¹‹å‰çš„å¯¹è¯ï¼š\n${historyContext}\n\nçŽ°åœ¨æˆ‘çš„æ–°é—®é¢˜æ˜¯ï¼š${message}`
  }
  ...
  if (res.success && res.data) {
    // æ­£ç¡®çš„æ•°æ®è·¯å¾„: res.data.result.results æ˜¯ä¸€ä¸ªå¯¹è±¡å­—å…¸
    // æ ¼å¼: {"twitter_0": {...}, "reddit_0": {...}} æˆ–å•å¹³å° {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // å°†å¯¹è±¡å­—å…¸è½¬æ¢ä¸ºæ•°ç»„ï¼Œä¼˜å…ˆèŽ·å– reddit å¹³å°çš„å›žå¤
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // ä¼˜å…ˆä½¿ç”¨ reddit å¹³å°å›žå¤ï¼Œå…¶æ¬¡ twitter
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} å·²å›žå¤`)
    } else {
...
const submitSurvey = async () => {
  ...
  addLog(`å‘é€é—®å·ç»™ ${selectedAgents.value.size} ä¸ªå¯¹è±¡...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      // æ­£ç¡®çš„æ•°æ®è·¯å¾„: res.data.result.results æ˜¯ä¸€ä¸ªå¯¹è±¡å­—å…¸
      // æ ¼å¼: {"twitter_0": {...}, "reddit_0": {...}, "twitter_1": {...}, ...}
      const resultData = res.data.result || res.data
      const resultsDict = resultData.results || resultData
      
      // å°†å¯¹è±¡å­—å…¸è½¬æ¢ä¸ºæ•°ç»„æ ¼å¼
      ...
      for (const interview of interviews) {
        ...
        if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
          ...
          if (agentResult) {
            responseContent = agentResult.response || agentResult.answer || 'æ— å“åº”'
          }
        } else if (Array.isArray(resultsDict)) {
          // å…¼å®¹æ•°ç»„æ ¼å¼
          const matchedResult = resultsDict.find(r => r.agent_id === agentIdx)
          if (matchedResult) {
            responseContent = matchedResult.response || matchedResult.answer || 'æ— å“åº”'
          }
        }
      ...
      addLog(`æ”¶åˆ° ${surveyResults.value.length} æ¡å›žå¤`)
    } else {
      throw new Error(res.error || 'è¯·æ±‚å¤±è´¥')
    }
  } catch (err) {
    addLog(`é—®å·å‘é€å¤±è´¥: ${err.message}`)
  } finally {
...
const loadReportData = async () => {
  ...
  try {
    addLog(`åŠ è½½æŠ¥å‘Šæ•°æ®: ${props.reportId}`)
    ...
    addLog(`åŠ è½½æŠ¥å‘Šå¤±è´¥: ${err.message}`)
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog('æŠ¥å‘Šæ•°æ®åŠ è½½å®Œæˆ')
    }
  } catch (err) {
    addLog(`åŠ è½½æŠ¥å‘Šæ—¥å¿—å¤±è´¥: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`åŠ è½½äº† ${profiles.value.length} ä¸ªæ¨¡æ‹Ÿä¸ªä½“`)
    }
  } catch (err) {
    addLog(`åŠ è½½æ¨¡æ‹Ÿä¸ªä½“å¤±è´¥: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Step5 æ·±åº¦äº’åŠ¨åˆå§‹åŒ–')
  loadReportData()
  loadProfiles()
...
/* Left Panel - Report Style (ä¸Ž Step4Report.vue å®Œå…¨ä¸€è‡´) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* ä¿®å¤æœ‰åºåˆ—è¡¨ç¼–å· - ä½¿ç”¨ CSS è®¡æ•°å™¨è®©å¤šä¸ª ol è¿žç»­ç¼–å· */
.message-text {
