    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">æ¨¡æ‹Ÿå®žä¾‹åˆå§‹åŒ–</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">å·²å®Œæˆ</span>
            <span v-else class="badge processing">åˆå§‹åŒ–</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            æ–°å»ºsimulationå®žä¾‹ï¼Œæ‹‰å–æ¨¡æ‹Ÿä¸–ç•Œå‚æ•°æ¨¡ç‰ˆ
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            ç»“åˆä¸Šä¸‹æ–‡ï¼Œè‡ªåŠ¨è°ƒç”¨å·¥å…·ä»ŽçŸ¥è¯†å›¾è°±æ¢³ç†å®žä½“ä¸Žå…³ç³»ï¼Œåˆå§‹åŒ–æ¨¡æ‹Ÿä¸ªä½“ï¼Œå¹¶åŸºäºŽçŽ°å®žç§å­èµ‹äºˆä»–ä»¬ç‹¬ç‰¹çš„è¡Œä¸ºä¸Žè®°å¿†
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">çŽ°å®žç§å­å½“å‰å…³è”è¯é¢˜æ•°</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">å·²ç”Ÿæˆçš„ Agent äººè®¾</span>
            </div>
            <div class="profiles-list">
              ...
              >
                ...
                <div class="profile-meta">
                  <span class="profile-profession">{{ profile.profession || 'æœªçŸ¥èŒä¸š' }}</span>
                </div>
      ...
      <!-- Step 03: ç”ŸæˆåŒå¹³å°æ¨¡æ‹Ÿé…ç½® -->
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">03</span>
            <span class="step-title">ç”ŸæˆåŒå¹³å°æ¨¡æ‹Ÿé…ç½®</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">å·²å®Œæˆ</span>
            <span v-else-if="phase === 2" class="badge processing">ç”Ÿæˆä¸­</span>
            <span v-else class="badge pending">ç­‰å¾…</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM æ ¹æ®æ¨¡æ‹Ÿéœ€æ±‚ä¸ŽçŽ°å®žç§å­ï¼Œæ™ºèƒ½è®¾ç½®ä¸–ç•Œæ—¶é—´æµé€Ÿã€æŽ¨èç®—æ³•ã€æ¯ä¸ªä¸ªä½“çš„æ´»è·ƒæ—¶é—´æ®µã€å‘è¨€é¢‘çŽ‡ã€äº‹ä»¶è§¦å‘ç­‰å‚æ•°
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              ...
              <div class="time-periods">
                ...
                <div class="period-item">
                  <span class="period-label">ä½Žè°·æ—¶æ®µ</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">æŽ¨èç®—æ³•é…ç½®</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">æ—¶æ•ˆæƒé‡</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.recency_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">çƒ­åº¦æƒé‡</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.popularity_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">ç›¸å…³æ€§æƒé‡</span>
                    ...
                    <div class="param-row">
                      <span class="param-label">å›žéŸ³å®¤å¼ºåº¦</span>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">LLM é…ç½®æŽ¨ç†</span>
              </div>
      ...
      <!-- Step 04: åˆå§‹æ¿€æ´»ç¼–æŽ’ -->
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">04</span>
            <span class="step-title">åˆå§‹æ¿€æ´»ç¼–æŽ’</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">å·²å®Œæˆ</span>
            <span v-else-if="phase === 3" class="badge processing">ç¼–æŽ’ä¸­</span>
            <span v-else class="badge pending">ç­‰å¾…</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            åŸºäºŽå™äº‹æ–¹å‘ï¼Œè‡ªåŠ¨ç”Ÿæˆåˆå§‹æ¿€æ´»äº‹ä»¶ä¸Žçƒ­ç‚¹è¯é¢˜ï¼Œå¼•å¯¼æ¨¡æ‹Ÿä¸–ç•Œçš„åˆå§‹çŠ¶æ€
          </p>
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">åˆå§‹çƒ­ç‚¹è¯é¢˜</span>
            ...
            <div class="initial-posts-section">
              <span class="box-label">åˆå§‹æ¿€æ´»åºåˆ— ({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">æ¨¡æ‹ŸçŽ¯å¢ƒå·²å‡†å¤‡å®Œæˆï¼Œå¯ä»¥å¼€å§‹è¿è¡Œæ¨¡æ‹Ÿ</p>
          
          <!-- æ¨¡æ‹Ÿè½®æ•°é…ç½® - åªæœ‰åœ¨é…ç½®ç”Ÿæˆå®Œæˆä¸”è½®æ•°è®¡ç®—å‡ºæ¥åŽæ‰æ˜¾ç¤º -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">æ¨¡æ‹Ÿè½®æ•°è®¾å®š</span>
                <span class="section-desc">aarambh è‡ªåŠ¨è§„åˆ’æŽ¨æ¼”çŽ°å®ž <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> å°æ—¶ï¼Œæ¯è½®ä»£è¡¨çŽ°å®ž <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> åˆ†é’Ÿæ—¶é—´æµé€</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">è‹¥é¦–æ¬¡è¿è¡Œï¼Œå¼ºçƒˆå»ºè®®åˆ‡æ¢è‡³â€˜è‡ªå®šä¹‰æ¨¡å¼â€™å‡å°‘æ¨¡æ‹Ÿè½®æ•°ï¼Œä»¥ä¾¿å¿«é€Ÿé¢„è§ˆæ•ˆæžœå¹¶é™ä½ŽæŠ¥é”™é£Žé™© âž</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">çŽ°å®žç§å­å…³è”è¯é¢˜</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">äº‹ä»¶å…¨æ™¯ç»åŽ†</span>
                <span class="dim-desc">åœ¨æ­¤äº‹ä»¶ä¸­çš„å®Œæ•´è¡Œä¸ºè½¨è¿¹</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">è¡Œä¸ºæ¨¡å¼ä¾§å†™</span>
                <span class="dim-desc">ç»éªŒæ€»ç»“ä¸Žè¡Œäº‹é£Žæ ¼åå¥½</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">ç‹¬ç‰¹è®°å¿†å°è®°</span>
                <span class="dim-desc">åŸºäºŽçŽ°å®žç§å­å½¢æˆçš„è®°å¿†</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">ç¤¾ä¼šå…³ç³»ç½‘ç»œ</span>
                <span class="dim-desc">ä¸ªä½“é“¾æŽ¥ä¸Žäº¤äº’å›¾è°±</span>
              </div>
            </div>
...
const props = defineProps({
  simulationId: String,  // ä»Žçˆ¶ç»„ä»¶ä¼ å…¥
  projectData: Object,
  graphData: Object,
  systemLogs: Array
})
...
// State
const phase = ref(0) // 0: åˆå§‹åŒ–, 1: ç”Ÿæˆäººè®¾, 2: ç”Ÿæˆé…ç½®, 3: å®Œæˆ
...
// æ—¥å¿—åŽ»é‡ï¼šè®°å½•ä¸Šä¸€æ¬¡è¾“å‡ºçš„å…³é”®ä¿¡æ¯
...
const customMaxRounds = ref(40)   // é»˜è®¤æŽ¨è40è½®

// Watch stage to update phase
watch(currentStage, (newStage) => {
  if (newStage === 'ç”ŸæˆAgentäººè®¾' || newStage === 'generating_profiles') {
    phase.value = 1
  } else if (newStage === 'ç”Ÿæˆæ¨¡æ‹Ÿé…ç½®' || newStage === 'generating_config') {
    phase.value = 2
    // è¿›å…¥é…ç½®ç”Ÿæˆé˜¶æ®µï¼Œå¼€å§‹è½®è¯¢é…ç½®
    if (!configTimer) {
      addLog('å¼€å§‹ç”ŸæˆåŒå¹³å°æ¨¡æ‹Ÿé…ç½®...')
      startConfigPolling()
    }
  } else if (newStage === 'å‡†å¤‡æ¨¡æ‹Ÿè„šæœ¬' || newStage === 'copying_scripts') {
    phase.value = 2 // ä»å±žäºŽé…ç½®é˜¶æ®µ
  }
})

// ä»Žé…ç½®ä¸­è®¡ç®—è‡ªåŠ¨ç”Ÿæˆçš„è½®æ•°ï¼ˆä¸ä½¿ç”¨ç¡¬ç¼–ç é»˜è®¤å€¼ï¼‰
const autoGeneratedRounds = computed(() => {
  if (!simulationConfig.value?.time_config) {
    return null // é…ç½®æœªç”Ÿæˆæ—¶è¿”å›ž null
  }
  const totalHours = simulationConfig.value.time_config.total_simulation_hours
  const minutesPerRound = simulationConfig.value.time_config.minutes_per_round
  if (!totalHours || !minutesPerRound) {
    return null // é…ç½®æ•°æ®ä¸å®Œæ•´æ—¶è¿”å›ž null
  }
  const calculatedRounds = Math.floor((totalHours * 60) / minutesPerRound)
  // ç¡®ä¿æœ€å¤§è½®æ•°ä¸å°äºŽ40ï¼ˆæŽ¨èå€¼ï¼‰ï¼Œé¿å…æ»‘åŠ¨æ¡èŒƒå›´å¼‚å¸¸
...
// æ ¹æ®agent_idèŽ·å–å¯¹åº”çš„username
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    // ç”¨æˆ·é€‰æ‹©ä¿æŒè‡ªåŠ¨ç”Ÿæˆçš„è½®æ•°ï¼Œä¸ä¼ é€’ max_rounds å‚æ•°
...
const startPrepareSimulation = async () => {
  ...
  // æ ‡è®°ç¬¬ä¸€æ­¥å®Œæˆï¼Œå¼€å§‹ç¬¬äºŒæ­¥
  phase.value = 1
  addLog(`æ¨¡æ‹Ÿå®žä¾‹å·²åˆ›å»º: ${props.simulationId}`)
  addLog('æ­£åœ¨å‡†å¤‡æ¨¡æ‹ŸçŽ¯å¢ƒ...')
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('æ£€æµ‹åˆ°å·²æœ‰å®Œæˆçš„å‡†å¤‡å·¥ä½œï¼Œç›´æŽ¥ä½¿ç”¨')
      ...
      // ç«‹å³è®¾ç½®é¢„æœŸAgentæ€»æ•°ï¼ˆä»ŽprepareæŽ¥å£è¿”å›žå€¼èŽ·å–ï¼‰
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(`ä»ŽZepå›¾è°±è¯»å–åˆ° ${res.data.expected_entities_count} ä¸ªå®žä½“`)
        if (res.data.entity_types && res.data.entity_types.length > 0) {
          addLog(`  â””â”€ å®žä½“ç±»åž‹: ${res.data.entity_types.join(', ')}`)
        }
      }
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // åªæœ‰å½“ API è¿”å›žæœ‰æ•ˆå€¼æ—¶æ‰æ›´æ–°ï¼Œé¿å…è¦†ç›–å·²æœ‰çš„æœ‰æ•ˆå€¼
      ...
      // è¾“å‡º Profile ç”Ÿæˆè¿›åº¦æ—¥å¿—ï¼ˆä»…å½“æ•°é‡å˜åŒ–æ—¶ï¼‰
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        if (currentCount === 1) {
          addLog(`å¼€å§‹ç”ŸæˆAgentäººè®¾...`)
        }
        addLog(`â†’ Agentäººè®¾ ${currentCount}/${total}: ${profileName} (${latestProfile?.profession || 'æœªçŸ¥èŒä¸š'})`)
        
        // å¦‚æžœå…¨éƒ¨ç”Ÿæˆå®Œæˆ
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(`âœ“ å…¨éƒ¨ ${currentCount} ä¸ªAgentäººè®¾ç”Ÿæˆå®Œæˆ`)
        }
      }
    }
  } catch (err) {
    console.warn('èŽ·å– Profiles å¤±è´¥:', err)
  }
}
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // è¾“å‡ºé…ç½®ç”Ÿæˆé˜¶æ®µæ—¥å¿—ï¼ˆé¿å…é‡å¤ï¼‰
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        lastLoggedConfigStage = data.generation_stage
        if (data.generation_stage === 'generating_profiles') {
          addLog('æ­£åœ¨ç”ŸæˆAgentäººè®¾é…ç½®...')
        } else if (data.generation_stage === 'generating_config') {
          addLog('æ­£åœ¨è°ƒç”¨LLMç”Ÿæˆæ¨¡æ‹Ÿé…ç½®å‚æ•°...')
        }
      }
      ...
      if (data.config_generated && data.config) {
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('âœ“ çŽ¯å¢ƒæ­å»ºå®Œæˆï¼Œå¯ä»¥å¼€å§‹æ¨¡æ‹Ÿ')
        emit('update-status', 'completed')
      }
    }
  } catch (err) {
    console.warn('èŽ·å– Config å¤±è´¥:', err)
  }
}
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        // é…ç½®å°šæœªç”Ÿæˆï¼Œå¼€å§‹è½®è¯¢
        addLog('é…ç½®ç”Ÿæˆä¸­ï¼Œå¼€å§‹è½®è¯¢ç­‰å¾…...')
        startConfigPolling()
      }
    }
  } catch (err) {
...
onMounted(() => {
  // è‡ªåŠ¨å¼€å§‹å‡†å¤‡æµç¨‹
  if (props.simulationId) {
    addLog('Step2 çŽ¯å¢ƒæ­å»ºåˆå§‹åŒ–')
