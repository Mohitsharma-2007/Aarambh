...
export const OntologyReportView: React.FC = () => {
  ...
  const statusText = currentStatus === 'error' ? 'Error' : currentStatus === 'completed' ? 'Completed' : 'Generating'
      ...
      <header className="h-[60px] border-b border-gray-200 flex items-center justify-between px-6 bg-white relative z-10">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm">
            <span className="font-mono font-bold text-gray-400">Step 4/5</span>
            <span className="font-bold text-black">Report Generation</span>
          </div>
...
export default OntologyReportView
