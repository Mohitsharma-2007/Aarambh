...
export function GlobeComponent({ fullGlobe = false, className }: ComponentProps) {
  const lineColor1 = "#a78bfa"
  const lineColor2 = "#38bdf8"
  const lineColor3 = "#34d399"
    ...
    >
      <section
        ...
        style={{
          ...
          "--line-color-1": lineColor1,
          "--line-color-2": lineColor2,
          "--line-color-3": lineColor3,
          ...
          >
            ...
            <g id="animated-paths-globe">
              ...
              <g id="lllldll31" opacity="1">
                ...
                <defs>
                  <radialGradient cx="100" cy="100" gradientUnits="userSpaceOnUse" id="lllldll31-gradient" r="0">
                    <stop offset="0" stopColor={lineColor1} />
                    <stop offset="0.4" stopColor={lineColor1} />
                    <stop offset="1" stopColor={lineColor1} stopOpacity="0" />
                    <animate
                      attributeName="cx"
                      dur="5.5s"
                      keyTimes="0;0.091;0.182;0.273;0.364;0.455;0.545;0.636;0.727;0.818;1"
              ...
              <g id="llullldl34" opacity="1">
                ...
                <defs>
                  <radialGradient cx="100" cy="100" gradientUnits="userSpaceOnUse" id="llullldl34-gradient" r="0">
                    <stop offset="0" stopColor={lineColor2} />
                    <stop offset="0.4" stopColor={lineColor2} />
                    <stop offset="1" stopColor={lineColor2} stopOpacity="0" />
                    <animate
                      attributeName="cx"
                      dur="5.5s"
                      keyTimes="0;0.082;0.164;0.245;0.327;0.409;0.491;0.573;0.655;0.736;0.818;1"
              ...
              <g id="llldlll35" opacity="1">
                ...
                <defs>
                  <radialGradient cx="100" cy="100" gradientUnits="userSpaceOnUse" id="llldlll35-gradient" r="0">
                    <stop offset="0" stopColor={lineColor1} />
                    <stop offset="0.4" stopColor={lineColor1} />
                    <stop offset="1" stopColor={lineColor1} stopOpacity="0" />
                    <animate
              ...
              <g id="llddllll33" opacity="1">
                ...
                <defs>
                  <radialGradient cx="100" cy="100" gradientUnits="userSpaceOnUse" id="llddllll33-gradient" r="0">
                    <stop offset="0" stopColor={lineColor3} />
                    <stop offset="0.4" stopColor={lineColor3} />
                    <stop offset="1" stopColor={lineColor3} stopOpacity="0" />
                    <animate
                      attributeName="cx"
                      dur="5.5s"
                      keyTimes="0;0.082;0.164;0.245;0.327;0.409;0.491;0.573;0.655;0.736;0.818;1"
              ...
              <g id="lllddlll34" opacity="1">
                ...
                <defs>
                  <radialGradient cx="100" cy="100" gradientUnits="userSpaceOnUse" id="lllddlll34-gradient" r="0">
                    <stop offset="0" stopColor={lineColor2} />
                    <stop offset="0.4" stopColor={lineColor2} />
                    <stop offset="1" stopColor={lineColor2} stopOpacity="0" />
                    <animate
              ...
              <g id="llullll32" opacity="1">
                ...
                <defs>
                  <radialGradient cx="100" cy="100" gradientUnits="userSpaceOnUse" id="llullll32-gradient" r="0">
                    <stop offset="0" stopColor={lineColor3} />
                    <stop offset="0.4" stopColor={lineColor3} />
                    <stop offset="1" stopColor={lineColor3} stopOpacity="0" />
                    <animate
            ...
            {fullGlobe && (
              <g transform="translate(0,800) scale(1,-1)" opacity="0.5">
                <use href="#animated-paths-globe" />
              </g>
            )}
          </svg>
        </div>
